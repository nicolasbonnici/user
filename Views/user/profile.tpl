...
<div class="modal-body">
    ...
    <form class="form-horizontal" role="form" action="" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="password" class="form-control" placeholder="{{tr['input_password']}}" name="password"
                    class=""> <input type="password" class="form-control"
                    placeholder="{{tr['input_new_password']}}" name="passwordNew1" class=""> <input
                    type="password" class="form-control" placeholder="{{tr['confirm_new_password']}}"
